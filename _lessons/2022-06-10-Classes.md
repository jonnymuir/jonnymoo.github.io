...
We can also have "attributes" - things that belong to a LaserFrog. We are going to create a laser charge as an attribute. To set an attribute we have to tell the class what we want to set it to when initialise and instance of itself. 
